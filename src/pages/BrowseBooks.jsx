...
import { Grid, Container, Loader, Text, Center, Pagination, TextInput, ActionIcon } from "@mantine/core";
...
<Container px="md" className={classes.browseBooksContainer}>
    ...
    <ActionIcon size={42} variant="gradient" gradient={{ from: 'green', to: 'lightgreen' }} onClick={handleSearch} title="Search">
